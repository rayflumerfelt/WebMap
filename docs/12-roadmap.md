...
| 4 — Gridding | **In progress.** 9 of 10 verified. Jobs, contouring with gapped labels ([`adr/0015`](adr/0015-contour-labels-gap-the-line.md)), lineage, breaklines, clipping, label anchors and dataset sync are done; the worker's ingest and export tasks are what remain. |
...
**Still owed by Phase 4:** the worker's ingest and export tasks. **Sync is built** — the

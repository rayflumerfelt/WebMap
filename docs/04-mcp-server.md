...
Twenty-three tools in six groups, of which **seventeen are implemented**. The rest are specified
...
| Analysis | `webmap_interpolate`, `webmap_contour`, `webmap_aggregate`, `webmap_fit_variogram`, `webmap_clip_grid`, `webmap_label_anchors` | ✓ all six |

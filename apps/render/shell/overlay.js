(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.WebMapOverlay = {}));
  ...
  function parseHex(value) {
    ...
    if (!match) {
      throw new Error(`'${value}' is not a hex colour. Palette stops are #rgb or #rrggbb; named colours and rgb() are not accepted because the Python compiler would have to reproduce a colour table to match.`);
    }
  ...
  function colourAt(palette, position) {
    ...
    if (stops.length === 1)
      return toHex(parseHex(stops[0].color));
    ...
    for (let i = stops.length - 1; i >= 0; i -= 1) {
      if (stops[i].position === target)
        return toHex(parseHex(stops[i].color));
    }
  ...
  function sortedStops(palette) {
    return palette.stops.map((stop, index) => ({ stop, index })).sort((a, b) => a.stop.position - b.stop.position || a.index - b.index).map(({ stop }) => stop);
  }
  function Legend({ spec, className }) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: 600, marginBottom: 4 }, children: spec.title }),
          spec.kind === "classes" ? /* @__PURE__ */ jsxRuntimeExports.jsx(CategoryLegend, { spec }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ColorBar, { spec })
        ]
      }
    );
  }
  function CategoryLegend({ spec }) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { style: { listStyle: "none", margin: 0, padding: 0 }, children: spec.entries.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "li",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: entry.label })
        ]
      },
      `${entry.swatch}:${entry.label}`
    )) });
  }
  const BAR_STOPS = 32;
  function ColorBar({ spec }) {
    const [low, high] = spec.range;
    const gradient = rampGradient(spec.palette);
    const suffix = spec.unit ? ` ${spec.unit}` : "";
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { minWidth: 160 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          role: "img",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "relative", height: 14, marginTop: 2 }, children: spec.ticks.map((tick) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
          style: {
            position: "absolute",
          ...
          children: tick.toLocaleString("en-US")
        },
        tick
      )) }),
      spec.unit ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { textAlign: "right", opacity: 0.75 }, children: spec.unit }) : null
    ] });
  }
  function rampGradient(palette) {
    if (palette.interpolation === "discrete") {
  ...
  function NorthArrow({ bearing, always = false, size = 32, className }) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className,
        role: "img",
        "aria-label": Math.abs(rotation) < NORTH_UP_TOLERANCE_DEG ? "North arrow: map is north-up" : `North arrow: map is rotated ${Math.round(rotation)} degrees`,
        style: {
          width: size,
          height: size,
          display: "grid",
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "svg",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M12 2 L17 20 L12 16 L7 20 Z", fill: "#242e39" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "text",
                {
                  x: "12",
  ...
  function normaliseBearing(bearing) {
    const wrapped = (bearing % 360 + 360) % 360;
    return wrapped > 180 ? wrapped - 360 : wrapped;
  }
  const EQUATORIAL_CIRCUMFERENCE_M = 40075016686e-3;
  ...
  function scaleBar(latitude, zoom, maxWidthPx, unit = "metric") {
  ...
  function metricBar(maxMeters, mpp) {
    const meters = largestNiceAtMost(maxMeters);
    const useKm = meters >= 1e3;
    return {
      widthPx: meters / mpp,
      distance: useKm ? meters / 1e3 : meters,
      unit: useKm ? "km" : "m",
      label: `${format(useKm ? meters / 1e3 : meters)} ${useKm ? "km" : "m"}`
    };
  }
  function imperialBar(maxMeters, mpp) {
  ...
  function largestNiceAtMost(limit) {
  ...
  function ScaleBar({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { textAlign: "center" }, children: bar.label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
  ...
  function Overlay({ spec }) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          spec.title ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: corner("top-left"), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              style: {
                padding: "6px 10px",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 15, fontWeight: 600 }, children: spec.title.text }),
                spec.title.subtitle ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 11, opacity: 0.8 }, children: spec.title.subtitle }) : null
              ]
            }
          ) }) : null,
          spec.northArrow ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: corner("top-right"), children: /* @__PURE__ */ jsxRuntimeExports.jsx(NorthArrow, { ...spec.northArrow }) }) : null,
          spec.scaleBar ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: corner("bottom-left"), children: /* @__PURE__ */ jsxRuntimeExports.jsx(ScaleBar, { ...spec.scaleBar }) }) : null,
          spec.legend ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: corner("bottom-right"), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Legend, { spec: spec.legend }) }) : null,
          spec.provenance ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
  ...
  function mount(container, spec) {
    root ?? (root = clientExports.createRoot(container));
    root.render(
      /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Overlay, { spec }) })
    );
  }
  function unmount() {
